...
export class IslamicWisdomService {
  ...
  /**
   * Compress an image file to Base64 data URL within safe Firestore document limits (<500KB)
   */
  static compressImageFile(file: File, maxWidth = 1200, maxHeight = 1200, quality = 0.82): Promise<string> {
